...
* Пример запроса: http://localhost:8080/deleted/offices
* Тип запроса **GET**
* Тело запроса отсутствует:
...
* Пример запроса: http://localhost:8080/status/1000000013
* Тип запроса **GET**
* Тело запроса отсутствует:
...
* Пример запроса: http://localhost:8080/point/1000000013
* Тип запроса **POST**
* Тело запроса отсутствует:
...
* Просмотр истории движения почтового отправления.
* Пример запроса: http://localhost:8080/history/1000000013
* Тип запроса **GET**
* Тело запроса отсутствует:
...
* Просмотр списка актуальных почтовых отправлений
* Пример запроса: http://localhost:8080/item/actual
* Тип запроса **GET**
* Тело запроса отсутствует:
...
* Просмотр архива почтовых отправлений
* Пример запроса: http://localhost:8080/item/archive
* Тип запроса **GET**
* Тело запроса отсутствует:
...
* Пример запроса: http://localhost:8080/item/1000000013
* Тип запроса **GET**
* Тело запроса отсутствует:
...
по адресу: http://localhost:8080/mailing